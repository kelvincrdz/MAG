  ...
  async function onFileChange(e) {
    ...
    try {
      ...
      try {
        ...
        let audioList = (magResp.audioFiles || []).map((a) => ({
          id: a.id,
          magId: a.mag_id,
          ...
          role: a.role,
          associationTag: a.association_tag,
          internalPath: a.internal_path,
        }));
        // Garante que o Depoimento venha primeiro
        audioList.sort(
          (x, y) => (y.role === "primary") - (x.role === "primary")
        );
        ...
        console.warn(
          "Falha ao processar no backend, usando processamento local:",
          err.message
        );
      }
